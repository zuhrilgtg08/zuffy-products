        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Edit Category</p>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                @error('name_category') is-invalid @enderror" required
                                    value="{{ old('name_category', $category->name_category) }}" placeholder="Name Category" />
                                @error('name_category')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                @error('slug') is-invalid @enderror" required
                                    value="{{ old('slug', $category->slug) }}" placeholder="Slug Category" />
                                @error('slug')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
