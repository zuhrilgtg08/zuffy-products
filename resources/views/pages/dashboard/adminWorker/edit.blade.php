        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Data Worker</h3>
                    <p class="text-subtitle text-muted">Edit Worker</p>
                    @if (session()->has('fail'))
                    ...
                    <form action="{{ route('admin.workers.update', $worker->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="fullname" name="fullname" class="form-control 
                                             @error('fullname') is-invalid @enderror" required 
                                                value="{{ old('fullname', $worker->fullname) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="alamat-worker" name="w_ket_alamat" class="form-control 
                                         @error('w_ket_alamat') is-invalid @enderror" required 
                                                value="{{ old('w_ket_alamat', $worker->w_ket_alamat) }}"
                               ...
                               <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        @error('username') is-invalid @enderror" required
                                            value="{{ old('username', $worker->username) }}" placeholder="Your Username" />
                                        @error('username')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <select name="w_provinsi_id" id="provinces-list" class="form-select @error('w_provinsi_id') is-invalid @enderror" required>
                                            ...
                                            @foreach ($provinsi as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ ($worker->w_provinsi_id == $item->id) ? 'selected' : '' }}>{{ $item->name_province }}</option>
                                            @endforeach
                                        </select>
                                        @error('w_provinsi_id')
                                            <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="w_kota_id" id="kota-list" class="form-select @error('w_kota_id') is-invalid @enderror"
                                            required>
                                            <option value="{{ $worker->w_kota_id }}" selected>{{ $worker->kota->nama_kab_kota }}</option>
                                        </select>
                                        @error('w_kota_id')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" id="tgl-lahir" name="tgl_lahir" class="form-control 
                                            @error('tgl_lahir') is-invalid @enderror flatpickr-no-config" required 
                                                value="{{ old('tgl_lahir', $worker->tgl_lahir) }}"
                        ...
                        <div class="col-lg-5 my-2">
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $worker->image_profile_worker }}">
                                @if ($worker->image_profile_worker)
                                    <img src="{{ asset('storage/' . $worker->image_profile_worker) }}" alt="img-worker" 
                                        class="rounded-circle gambar-preview my-3" width="250" height="250"/>
                                @else
                                    <img src="{{ asset('assets/frontend/images/profile.svg') }}" 
                                        class="rounded-circle gambar-preview my-3" width="250"
                                            height="250" alt="img-worker" />
                                @endif
                        ...
                        <div class="mb-3">
                            ...
                            <div id="snow-editor" style="min-height: 150px">{!! $worker->bio_worker !!}</div>
                            <input type="hidden" name="bio_worker" id="bio-worker"
                                class="@error('bio_worker') is-invalid @enderror"
                                value="{{ old('bio_worker', $worker->bio_worker) }}" required/>
                            @error('bio_worker')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
